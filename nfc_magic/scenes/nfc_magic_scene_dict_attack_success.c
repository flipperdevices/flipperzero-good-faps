...
void nfc_magic_scene_dict_attack_success_widget_callback(
...
void nfc_magic_scene_dict_attack_success_on_enter(void* context) {
    NfcMagicApp* instance = context;
    ...
    widget_add_button_element(
        ...
        GuiButtonTypeLeft,
        "Retry",
        nfc_magic_scene_dict_attack_success_widget_callback,
        instance);
    widget_add_button_element(
        widget,
        GuiButtonTypeRight,
...
bool nfc_magic_scene_dict_attack_success_on_event(void* context, SceneManagerEvent event) {
    NfcMagicApp* instance = context;
    bool consumed = false;
...
void nfc_magic_scene_dict_attack_success_on_exit(void* context) {
    NfcMagicApp* instance = context;
