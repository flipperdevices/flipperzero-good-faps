...
NfcCommand
    nfc_magic_scene_gen4_write_otp_poller_callback(Gen4PollerEvent event, void* context) {
...
void nfc_magic_scene_gen4_write_otp_on_enter(void* context) {
    ...
    gen4_poller_struct_set_otp(
        instance->gen4_poller, instance->byte_input_store, 4);
