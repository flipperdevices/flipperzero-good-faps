...
NfcCommand
    nfc_magic_scene_gen4_write_pack_poller_callback(Gen4PollerEvent event, void* context) {
...
void nfc_magic_scene_gen4_write_pack_on_enter(void* context) {
    ...
    gen4_poller_struct_set_pack(
        instance->gen4_poller, instance->byte_input_store, 2);
