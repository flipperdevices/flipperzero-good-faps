...
void picopass_scene_loclass_old_on_enter(void* context) {
    Picopass* picopass = context;
...
bool picopass_scene_loclass_old_on_event(void* context, SceneManagerEvent event) {
    Picopass* picopass = context;
    bool consumed = false;
...
void picopass_scene_loclass_old_on_exit(void* context) {
    Picopass* picopass = context;
